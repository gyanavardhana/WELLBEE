              ...
              <ul className="mt-4 space-y-2">
                {recommendations.map((rec, index) => (
                  <li key={index} className="bg-gray-100 p-2 rounded">
                    {rec.name}{" "}
                    {/* Adjust this property based on your API response structure */}
                  </li>
                ))}
              </ul>
            </div>
                ...
                <div className="mt-4">
                  ...
                  <ul className="list-disc pl-5 mt-2 bg-gray-100 p-4 rounded-lg">
                    <li>
                      ...
                      {healthInfo.caloriesGained || "N/A"}
                    </li>
                    <li>
                      <strong>Protein:</strong>{" "}
                      {healthInfo.totalProtein || "N/A"} g
                    </li>
                    <li>
                      <strong>Carbohydrates:</strong>{" "}
                      {healthInfo.totalCarbohydrates || "N/A"} g
                    </li>
                    <li>
                      <strong>Fats:</strong> {healthInfo.totalFat || "N/A"} g
                    </li>
                    <li>
                      <strong>Fiber:</strong> {healthInfo.totalFiber || "N/A"} g
                    </li>
                  </ul>
                </div>
              )}
